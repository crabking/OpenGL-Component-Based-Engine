#pragma once
/*!
\file ThirdPersonCameraComponent.h
*/
#include <glm/glm.hpp>
...
public:
	...
	*/
	ThirdPersonCameraComponent(glm::vec3& pos) { m_position = pos; }
	...
	*/
	ThirdPersonCameraComponent(glm::vec3& pos,glm::quat& orient) { m_position = pos; m_orientation = orient; }
